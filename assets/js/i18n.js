...
const FARMIQ_I18N_KEYS = {
  ...
  'Sign In': 'Sign In',
  'Sign Out': 'Sign Out',
  'Get Your Free Forecast': 'Get Your Free Forecast',
...
const FARMIQ_DICT = {
  es: {
    'Home': 'Inicio', 'How It Works': 'Cómo Funciona',
    ...
    'Get Your Free Forecast': 'Obtén Tu Pronóstico Gratis', 'See Pricing': 'Ver Precios',
  ...
  fr: {
    'Home': 'Accueil', 'How It Works': 'Comment Ça Marche',
    ...
    'Get Your Free Forecast': 'Obtenez Vos Prévisions Gratuites', 'See Pricing': 'Voir les Tarifs',
  ...
  de: {
    'Home': 'Startseite', 'How It Works': 'So Funktioniert’s',
    ...
    'Get Your Free Forecast': 'Kostenlose Prognose Erhalten', 'See Pricing': 'Preise Ansehen',
  ...
  it: {
    'Home': 'Home', 'How It Works': 'Come Funziona',
    ...
    'Get Your Free Forecast': 'Ottieni Previsioni Gratuite', 'See Pricing': 'Vedi i Prezzi',
  ...
  nl: {
    'Home': 'Home', 'How It Works': 'Hoe Het Werkt',
    ...
    'Get Your Free Forecast': 'Ontvang Je Gratis Voorspelling', 'See Pricing': 'Bekijk Prijzen',
  ...
  pl: {
    'Home': 'Strona Główna', 'How It Works': 'Jak To Działa',
    ...
    'Get Your Free Forecast': 'Odbierz Darmową Prognozę', 'See Pricing': 'Zobacz Cennik',
  ...
  ro: {
    'Home': 'Acasă', 'How It Works': 'Cum Funcționează',
    ...
    'Get Your Free Forecast': 'Obține Prognoza Gratuită', 'See Pricing': 'Vezi Prețurile',
  ...
  sv: {
    'Home': 'Hem', 'How It Works': 'Så Fungerar Det',
    ...
    'Get Your Free Forecast': 'Få Din Gratis Prognos', 'See Pricing': 'Se Priser',
  ...
  da: {
    'Home': 'Hjem', 'How It Works': 'Sådan Fungerer Det',
    ...
    'Get Your Free Forecast': 'Få Din Gratis Prognose', 'See Pricing': 'Se Priser',
    ...
    'Home': 'Etusivu', 'How It Works': 'Näin Se Toimii',
    ...
    'Get Your Free Forecast': 'Hanki Ilmainen Ennuste', 'See Pricing': 'Katso Hinnat',
  ...
  pt: {
    'Home': 'Início', 'How It Works': 'Como Funciona',
    ...
    'Get Your Free Forecast': 'Obtenha Sua Previsão Grátis', 'See Pricing': 'Ver Preços',
