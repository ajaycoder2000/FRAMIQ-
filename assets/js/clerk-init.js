      ...
      if (window.Clerk) {
        window.Clerk.load({
          appearance: {
            variables: {
              colorPrimary: '#c9a84c',
              colorBackground: '#0c1410',
              colorInputBackground: '#17201a',
              colorInputText: '#e9ede6',
              colorText: '#e9ede6',
              colorTextSecondary: 'rgba(233,237,230,.65)',
              colorNeutral: '#e9ede6',
              borderRadius: '8px',
              fontFamily: "'Inter', system-ui, sans-serif",
            },
            elements: {
              card: { backgroundColor: '#17201a', border: '1px solid rgba(233,237,230,.16)' },
